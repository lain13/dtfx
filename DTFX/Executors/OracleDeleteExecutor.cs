...
{
    /// <summary>
    /// Oracleデータ削除処理(OracleDelete)
    /// ORACLEサーバーに削除SQLを実行する。
    /// </summary>
    public class OracleDeleteExecutor : ExecutorBase
    {
        ...
        /// <summary>
        /// XElementからOracleDeleteElementを生成します。
        /// </summary>
        /// <param name="rawElement">XElement</param>
        /// <returns>OracleDeleteElement</returns>
        public OracleDeleteElement CreateElement(XElement rawElement)
        {
            OracleDeleteElement obj = new OracleDeleteElement();
